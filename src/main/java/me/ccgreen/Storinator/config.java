...
public class config {
	...
	private static ItemStack[] unlockIcon = new ItemStack[8];
			...
			if(!configFile.exists()){
				...
				try {
					if(configFile.createNewFile()){
						String[] names = {"Buy me!", "Find me!", "Edit me in config!", "Rename me!", "Woot! Settings!", "Im an unconfigured name!", "Powered by memes!", "cc wuz hear!"};
